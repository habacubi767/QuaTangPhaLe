            ...
            <section class="sidebar">
                ...
                <?php echo Menu::widget([
                    ...
                    'items'=>[
                        ...
                        [
                            'label'=>Yii::t('backend', 'System Category'),
                            'url' => '#',
                            'icon'=>'<i class="fa fa-edit"></i>',
                            'options'=>['class'=>'treeview'],
                            'items'=>[
                                ['label'=>Yii::t('backend', 'Branch'), 'url'=>['/branch/index'], 'icon'=>'<i class="fa fa-h-square"></i>'],
                                ['label'=>Yii::t('backend', 'Store'), 'url'=>['/store/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
