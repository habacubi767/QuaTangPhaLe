...
$bundle = MetroAsset::register($this);
...
<head>
    ...
    <?php $this->head() ?>
    <style type="text/css">
        .modal-dialog{margin: 30px auto; width: 860px !important;}
        .portlet{margin-bottom: 0px !important;}
        .form-section{margin: 0px !important;}
        .form-body{padding: 0px 20px !important;}
    </style>
</head>
...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="index.html">
                <img src="<?php echo Yii::$app->homeUrl ?>/img/logo.png" alt="logo" class="logo-default"/> </a>
    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="heading">
                    <h3 class="uppercase">Danh mục hệ thống</h3>
                </li>
                <li class="nav-item  ">
                    <a href="<?= Yii::$app->urlManager->createUrl('branch/index') ?>" class="nav-link nav-toggle">
                        <i class="icon-diamond"></i>
                        <span class="title">Chi nhánh/Cửa hàng</span>
                    </a>
                </li>
                <li class="nav-item  ">
                    <a href="javascript:;" class="nav-link nav-toggle">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <spam class="modal-title" id="myModalLabel"></spam>
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-actions right">
                        ...
                        <button type="button" class="btn blue form-submit">
...
$scripts = <<<EOD
    ...
    {
        setModalBox(title,content,"standart");
    ...
    $('.form-submit').click(function (e) {
        ...
        e.preventDefault();
        return $(this).parent().prev().children("form").submit();
    });    
